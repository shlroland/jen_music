...
class _PagePosition extends ScrollPositionWithSingleContext
  ...
  double getPixelsFromPage(double page) {
    return page *
        ((hasViewportDimension == true) ? viewportDimension : 0) *
        viewportFraction;
  }
  ...
  double get page => (hasPixels == false)
      ? null
      : getPageFromPixels(
          pixels.clamp((hasContentDimensions == true) ? minScrollExtent : null,
              (hasContentDimensions == true) ? maxScrollExtent : null),
